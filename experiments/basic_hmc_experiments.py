...
# Define HMC sampler using basic implementation of HMC
def hmc_sampling(dist):
    hmc_kernel = BasicHMC(dist, step_size=0.9, num_steps=4)
...
ax1[0].set_title('Unimodal symmetric distribution with basic HMC sampler')
...
ax1[1].set_title('Unimodal asymmetric distribution with basic HMC sampler')
...
ax2[0].set_title('Bimodal symmetric distribution with basic HMC sampler')
...
ax2[1].set_title('Bimodal asymmetric distribution with basic HMC sampler')
plt.show()
...
ax3[0].set_title('Trimodal symmetric distribution with basic HMC sampler')
...
ax3[1].set_title('Trimodal asymmetric distribution with basic HMC sampler')
plt.show()